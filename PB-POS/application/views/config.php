...
<div id="config_wrapper">
    <fieldset id="config_info">
        ...
        <div class="field_row clearfix">	
            ...
            <?php echo form_label($this->lang->line('config_currency_side'), 'currency_side', array('style' => 'width: 100px; text-align: center; display: inline-block; vertical-align: middle; float: none; line-height: 34px;')); ?>
                ...
                echo form_checkbox(array(
                    ...
                    'id' => 'currency_side',
                    'class' => 'form-control',
                    'style' => 'display: inline-block; width: auto;height: auto; vertical-align: middle; margin: auto;',
                    'value' => 'currency_side',
        ...
        <div class="field_row clearfix">	
            ...
            <div>
                ...
                echo form_dropdown('language', array(
                    ...
                    'Spanish' => 'Spanish',
                    'Russian' => 'Russian'
                        ), $this->config->item('language'), 'class="form-control" style="width: 300px;"');
                ?>
            </div>
        </div>
            ...
            <div>
                ...
                echo form_dropdown('timezone', array(
                    ...
                    'Pacific/Kiritimati' => '(GMT+14:00) Kiritimati'
                        ), $this->config->item('timezone') ? $this->config->item('timezone') : date_default_timezone_get(), 'class="form-control" style="width: 300px;"');
                ?>
            </div>
        </div>
        ...
        <div class="field_row clearfix">	
            ...
            <div>
                ...
                echo form_checkbox(array(
                    ...
                    'id' => 'print_after_sale',
                    'class' => 'form-control',
                    'style' => 'width: auto; margin: auto 0; display: inline-block',
        ...
        <div class="field_row clearfix">	
            <?php echo form_label($this->lang->line('config_use_customers') . ':', 'use_customers', array('class' => 'wide')); ?>
            <div>
                <?php
                echo form_checkbox(array(
                    'name' => 'use_customers',
                    ...
                    'style' => 'width: auto; margin: auto 0; display: inline-block',
                    'value' => 'use_customers',
                    'checked' => $this->config->item('use_customers')));
                ?>
            </div>
        </div>

        <div class="field_row clearfix">	
            <?php echo form_label($this->lang->line('config_use_giftcards') . ':', 'use_giftcards', array('class' => 'wide')); ?>
            <div>
                <?php
                echo form_checkbox(array(
                    'name' => 'use_giftcards',
                    ...
                    'style' => 'width: auto; margin: auto 0; display: inline-block',
                    'value' => 'use_giftcards',
                    'checked' => $this->config->item('use_giftcards')));
                ?>
            </div>
        </div>
