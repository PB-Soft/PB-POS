...
<fieldset id="item_basic_info">
    ...
    <div class="field_row clearfix">
        ...
        <div>
            <?php echo form_dropdown('supplier_id', $suppliers, $selected_supplier, 'class="form-control" style="width: 160px;"'); ?>
        </div>
    </div>
    ...
    <div class="field_row clearfix">
        ...
        <div>
            ...
            echo form_input(array(
                ...
                'class' => 'form-control input-sm',
                'style' => 'width: 50px;display: inline-block; margin-right: 0;',
                'size' => '3',
    ...
    <div class="field_row clearfix">
        <?php echo form_label('Editable by Employee:', 'is_editable', array('class' => 'wide')); ?>
        <div>
            <?php
            echo form_checkbox(array(
                'name' => 'is_editable',
                ...
                'style' =>' width: auto;',
                'value' => 1,
                'checked' => ($item_info->is_editable) ? 1 : 0)
            );
            ?>
        </div>
    </div>
