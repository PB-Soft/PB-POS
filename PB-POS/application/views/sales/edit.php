...
<div id="edit_sale_wrapper">
    ...
    <div class="field_row clearfix">
        ...
        <div>
            <?php echo anchor('sales/receipt/' . $sale_info['sale_id'], 'POS ' . $sale_info['sale_id'], array('target' => '_blank', 'class' => 'btn btn-link')); ?>
        </div>
    </div>
    ...
    <div class="field_row clearfix">
        ...
        <div >
            <?php echo form_input(array('name' => 'date', 'value' => date('m/d/Y', strtotime($sale_info['sale_time'])), 'id' => 'date', 'class' => 'form-control', 'style' => 'width:200px;')); ?>
        </div>
    </div>
    ...
    <div class="field_row clearfix">
        ...
        <div>
            <?php echo form_dropdown('customer_id', $customers, $sale_info['customer_id'], 'id="customer_id" class="form-control" style="width: 200px;"'); ?>
        </div>
    </div>
    ...
    <div class="field_row clearfix">
        ...
        <div>
            <?php echo form_dropdown('employee_id', $employees, $sale_info['employee_id'], 'id="employee_id" class="form-control" style="width: 200px;"'); ?>
        </div>
    </div>
    ...
    <div class="field_row clearfix">
        ...
        <div>
            <?php echo form_textarea(array('name' => 'comment', 'value' => $sale_info['comment'], 'rows' => '4', 'cols' => '23', 'id' => 'comment', 'class' => 'form-control', 'style' => 'width:200px;')); ?>
        </div>
    </div>
    ...
    echo form_submit(array(
        ...
        'class' => 'btn btn-success float_left')
    );
    ?>
</form>
<?php
